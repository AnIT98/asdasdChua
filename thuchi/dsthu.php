    ...
    <div class="row" id="ds">
        <div class="row">
            <div class="col-12 d-flex justify-content-center mb-1">
                <h3>Danh Sách Thu Chùa Long Thọ
                    <?php 
...
?>
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center mb-1">
                <form action="dsthu.php" method="GET">
                ...
                <table id="tbl_thuchi" class="table table-bordered display" style="min-width:800px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button type="button" class="btn btn-warning" onclick="xoa(<?php echo $row['id']?>)">Xóa</button>
